...
static auto const _c2py_fun_0 = c2py::dispatcher_f_kw_t{c2py::cmethod(
   [](_c2py_cls_0 &self,
      nda::basic_array<std::complex<double>, 3, nda::C_layout, 'A', nda::heap_basic<nda::mem::mallocator<nda::mem::AddressSpace::Host>>> Gt,
      std::string order) -> decltype(auto) { return self.G_calc(Gt, order); },
   "self", "Gt", "order")};
...
static auto const _c2py_fun_1 = c2py::dispatcher_f_kw_t{c2py::cmethod(
   [](_c2py_cls_0 &self,
      nda::basic_array<std::complex<double>, 3, nda::C_layout, 'A', nda::heap_basic<nda::mem::mallocator<nda::mem::AddressSpace::Host>>> Gt,
      nda::basic_array<int, 2, nda::C_layout, 'A', nda::heap_basic<nda::mem::mallocator<nda::mem::AddressSpace::Host>>> D,
      nda::basic_array<int, 1, nda::C_layout, 'A', nda::heap_basic<nda::mem::mallocator<nda::mem::AddressSpace::Host>>> diagramindex)
      -> decltype(auto) { return self.G_calc_group(Gt, D, diagramindex); },
...
static auto const _c2py_fun_2 = c2py::dispatcher_f_kw_t{c2py::cmethod(
   [](_c2py_cls_0 &self,
      nda::basic_array<std::complex<double>, 3, nda::C_layout, 'A', nda::heap_basic<nda::mem::mallocator<nda::mem::AddressSpace::Host>>> Gt,
      std::string order) -> decltype(auto) { return self.Sigma_calc(Gt, order); },
   "self", "Gt", "order")};
...
static auto const _c2py_fun_3 = c2py::dispatcher_f_kw_t{c2py::cmethod(
   [](_c2py_cls_0 &self,
      ...
      nda::basic_array<int, 2, nda::C_layout, 'A', nda::heap_basic<nda::mem::mallocator<nda::mem::AddressSpace::Host>>> D,
      nda::basic_array<int, 1, nda::C_layout, 'A', nda::heap_basic<nda::mem::mallocator<nda::mem::AddressSpace::Host>>> diagramindex)
      -> decltype(auto) { return self.Sigma_calc_group(Gt, D, diagramindex); },
   "self", "Gt", "D", "diagramindex")};

// copy_aaa_result
static auto const _c2py_fun_4 = c2py::dispatcher_f_kw_t{c2py::cmethod(
   [](_c2py_cls_0 &self, nda::basic_array<double, 1, nda::C_layout, 'V', nda::heap_basic<nda::mem::mallocator<nda::mem::AddressSpace::Host>>> pol0,
      nda::basic_array<std::complex<double>, 3, nda::C_layout, 'A', nda::heap_basic<nda::mem::mallocator<nda::mem::AddressSpace::Host>>> weights0)
      -> decltype(auto) { return self.copy_aaa_result(pol0, weights0); },
   "self", "pol0", "weights0")};

// free_greens
static auto const _c2py_fun_5 = c2py::dispatcher_f_kw_t{c2py::cmethod(
   [](_c2py_cls_0 &self, double beta,
      nda::basic_array<std::complex<double>, 2, nda::C_layout, 'A', nda::heap_basic<nda::mem::mallocator<nda::mem::AddressSpace::Host>>> H_S,
      double mu, bool time_order) -> decltype(auto) { return self.free_greens(beta, H_S, mu, time_order); },
...
static auto const _c2py_fun_6 = c2py::dispatcher_f_kw_t{c2py::cmethod(
   [](_c2py_cls_0 &self, double beta,
      nda::basic_array<std::complex<double>, 2, nda::C_layout, 'A', nda::heap_basic<nda::mem::mallocator<nda::mem::AddressSpace::Host>>> H_S)
      -> decltype(auto) { return self.free_greens_ppsc(beta, H_S); },
   "self", "beta", "H_S")};

// get_it_actual
static auto const _c2py_fun_7 =
   c2py::dispatcher_f_kw_t{c2py::cmethod([](_c2py_cls_0 &self) -> decltype(auto) { return self.get_it_actual(); }, "self")};

// hyb_decomposition
static auto const _c2py_fun_8 = c2py::dispatcher_f_kw_t{
   c2py::cmethod([](_c2py_cls_0 &self, bool poledlrflag, double eps) -> decltype(auto) { return self.hyb_decomposition(poledlrflag, eps); }, "self",
                 "poledlrflag"_a = true, "eps"_a = 0.0)};

// hyb_init
static auto const _c2py_fun_9 = c2py::dispatcher_f_kw_t{c2py::cmethod(
   [](_c2py_cls_0 &self,
      nda::basic_array<std::complex<double>, 3, nda::C_layout, 'A', nda::heap_basic<nda::mem::mallocator<nda::mem::AddressSpace::Host>>> Deltat0,
      bool poledlrflag) -> decltype(auto) { return self.hyb_init(Deltat0, poledlrflag); },
   "self", "Deltat0", "poledlrflag"_a = true)};

// number_of_diagrams
static auto const _c2py_fun_10 =
   c2py::dispatcher_f_kw_t{c2py::cmethod([](_c2py_cls_0 &self, int m) -> decltype(auto) { return self.number_of_diagrams(m); }, "self", "m")};

// partition_function
static auto const _c2py_fun_11 = c2py::dispatcher_f_kw_t{c2py::cmethod(
   [](_c2py_cls_0 &self,
      nda::basic_array<std::complex<double>, 3, nda::C_layout, 'A', nda::heap_basic<nda::mem::mallocator<nda::mem::AddressSpace::Host>>> Gt)
      -> decltype(auto) { return self.partition_function(Gt); },
   "self", "Gt")};
...
static auto const _c2py_fun_12 = c2py::dispatcher_f_kw_t{c2py::cmethod(
   [](_c2py_cls_0 &self, double beta,
      ...
      nda::basic_array_view<const std::complex<double>, 3, nda::C_stride_layout, 'A', nda::default_accessor,
         ...
         Sigma_t) -> decltype(auto) { return self.time_ordered_dyson(beta, H_S, eta_0, Sigma_t); },
...
PyMethodDef c2py::tp_methods<_c2py_cls_0>[] = {
   {"G_calc", (PyCFunction)c2py::pyfkw<_c2py_fun_0>, METH_VARARGS | METH_KEYWORDS, _c2py_doc_0.c_str()},
   {"G_calc_group", (PyCFunction)c2py::pyfkw<_c2py_fun_1>, METH_VARARGS | METH_KEYWORDS, _c2py_doc_1.c_str()},
   {"Sigma_calc", (PyCFunction)c2py::pyfkw<_c2py_fun_2>, METH_VARARGS | METH_KEYWORDS, _c2py_doc_2.c_str()},
   {"Sigma_calc_group", (PyCFunction)c2py::pyfkw<_c2py_fun_3>, METH_VARARGS | METH_KEYWORDS, _c2py_doc_3.c_str()},
   {"copy_aaa_result", (PyCFunction)c2py::pyfkw<_c2py_fun_4>, METH_VARARGS | METH_KEYWORDS, _c2py_doc_4.c_str()},
   {"free_greens", (PyCFunction)c2py::pyfkw<_c2py_fun_5>, METH_VARARGS | METH_KEYWORDS, _c2py_doc_5.c_str()},
   {"free_greens_ppsc", (PyCFunction)c2py::pyfkw<_c2py_fun_6>, METH_VARARGS | METH_KEYWORDS, _c2py_doc_6.c_str()},
   {"get_it_actual", (PyCFunction)c2py::pyfkw<_c2py_fun_7>, METH_VARARGS | METH_KEYWORDS, _c2py_doc_7.c_str()},
   {"hyb_decomposition", (PyCFunction)c2py::pyfkw<_c2py_fun_8>, METH_VARARGS | METH_KEYWORDS, _c2py_doc_8.c_str()},
   {"hyb_init", (PyCFunction)c2py::pyfkw<_c2py_fun_9>, METH_VARARGS | METH_KEYWORDS, _c2py_doc_9.c_str()},
   {"number_of_diagrams", (PyCFunction)c2py::pyfkw<_c2py_fun_10>, METH_VARARGS | METH_KEYWORDS, _c2py_doc_10.c_str()},
   {"partition_function", (PyCFunction)c2py::pyfkw<_c2py_fun_11>, METH_VARARGS | METH_KEYWORDS, _c2py_doc_11.c_str()},
   {"time_ordered_dyson", (PyCFunction)c2py::pyfkw<_c2py_fun_12>, METH_VARARGS | METH_KEYWORDS, _c2py_doc_12.c_str()},
...
constinit PyGetSetDef c2py::tp_getset<_c2py_cls_0>[] = {
   c2py::getsetdef_from_member<&_c2py_cls_0::Deltaiw, _c2py_cls_0>("Deltaiw", _c2py_doc_member_0),
   c2py::getsetdef_from_member<&_c2py_cls_0::Deltaiw_reflect, _c2py_cls_0>("Deltaiw_reflect", _c2py_doc_member_1),
   c2py::getsetdef_from_member<&_c2py_cls_0::dlr_if_dense, _c2py_cls_0>("dlr_if_dense", _c2py_doc_member_2),
