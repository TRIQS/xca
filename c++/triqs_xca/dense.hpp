...
class DenseFSet {
  public:
  nda::array<nda::dcomplex, 3> Fs;
  nda::array<nda::dcomplex, 3> F_dags;
  nda::array<nda::dcomplex, 4> F_dag_bars;
  nda::array<nda::dcomplex, 4> F_bars_refl;
   ...
   */
  DenseFSet(nda::array_const_view<nda::dcomplex, 3> Fs, 
            nda::array_const_view<nda::dcomplex, 3> F_dags, 
